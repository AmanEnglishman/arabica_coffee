...
@extend_schema(
    summary="Поиск продуктов по названию (регистронезависимый)", tags=["Menu"]
)
...
class ProductSearchAPIView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if search_query:
            return Product.objects.filter(is_active=True, title__icontains=search_query)
